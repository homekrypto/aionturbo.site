        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden lg:flex items-center space-x-2">
              ...
              >
                <button className={`nav-trigger ${isServicesOpen ? 'active' : ''}`}>
              ...
              >
                <button className={`nav-trigger ${isSolutionsOpen ? 'active' : ''}`}>
                ...
                <div className={`modern-dropdown ${isSolutionsOpen ? 'show' : ''}`}>
                  ...
                  <div className="dropdown-grid">
                    {Object.entries(groupedSolutions).slice(0, 3).map(([category, categoryItems]) => (
              ...
              >
                <button className={`nav-trigger ${isProductsOpen ? 'active' : ''}`}>
            ...
            <div className="lg:hidden bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 transition-colors duration-300">
              <div className="px-4 py-2 space-y-1">
                ...
                <div>
                  ...
                  {isServicesOpen && (
                    <div className="modern-dropdown show">
                      <Link href={`/${locale}/services`} className="view-all-btn" onClick={() => setIsMenuOpen(false)}>
                        {t("nav.services.all", locale)}
                      </Link>
                      <div className="dropdown-grid">
                ...
                <div>
                  ...
                  {isSolutionsOpen && (
                    <div className="modern-dropdown show">
                      <Link href={`/${locale}/solutions`} className="view-all-btn" onClick={() => setIsMenuOpen(false)}>
                        {t("nav.solutions.all", locale)}
                      </Link>
                      <div className="dropdown-grid">
                ...
                <div>
                  ...
                  {isProductsOpen && (
                    <div className="modern-dropdown show">
                      <Link href={`/${locale}/products`} className="view-all-btn" onClick={() => setIsMenuOpen(false)}>
                        {t("nav.products.all", locale)}
                      </Link>
                      <div className="dropdown-grid">
                        {products.map((product) => (
