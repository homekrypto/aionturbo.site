...
export default async function AiIntegrationPage({ params }: AiIntegrationPageProps) {
  ...
  const OriginalPage = await import('@/app/services/ai-integration/page').then(m => m.default);
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return {
    title: 'AI on Turbo - Ai Integration',
    description: 'Professional AI solutions and services',
    alternates: {
      canonical: `/${locale}/services/ai-integration`,
    },
  };
}
